...
export const demoData: AppData = {
  items: [
    ...
    },
    {
      ...
      rainOk: true,
      longWalkOk: true,
      memo: 'P6-3 장기 미착용 점검 흐름 확인용 Demo Item',
  ...
  wearLogs: [
    ...
    },
    {
      ...
      observedHvacMemo: '특별히 세거나 약하지 않았음',
      memo: '전체적으로 만족',
      temperatureSource: 'notion',
      weatherLocationId: null,
      weatherIssuedAt: null,
  ...
  places: [
    { id: 'place-cgv', name: 'CGV용산', kind: 'specific_venue' },
    { id: 'place-library', name: '도서관', kind: 'specific_venue' },
    { id: 'place-store', name: '편의점', kind: 'specific_venue' },
    { id: 'place-other', name: '기타', kind: 'generic_category' },
  ],
  placeHvacProfiles: [
    {
      ...
      memo: '오래 머무르면 겉옷이 필요함',
      source: 'wear_log_observation',
      lastConfirmedOn: '2026-06-18',
      createdAt: '2026-06-18T12:00:00+09:00',
    },
  ],
  transportModes: [
